...
?>
    ...
    <?php while ($row = $stmt->fetch()) { ?>
		  ...
		  <img src="<?php echo htmlspecialchars('images/' . $row['Image']);  /* prevent cross-site scripting (XSS) attacks. */?>" alt="<?php echo htmlspecialchars($product['Name']); ?>">
        <h2><?php echo htmlspecialchars($row['Name']); ?></h2>
        <p class="price"><span>Current price : </span><?php echo htmlspecialchars($row['Price']); ?> TND</p>
        <p><span>End auction : </span><?php echo htmlspecialchars($row['End_date']); ?></p>
        <p>  <br></p>
        <p><a href="auction.php?product_id=<?php echo htmlspecialchars($row['Product_id']); ?>" style="text-align: right; font-size: 2vh;">view details</a></p>
